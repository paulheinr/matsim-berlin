...
public final class CreateEnergyConsumptionDashboard implements MATSimAppCommand {
...
//            }
			...
			SimWrapperConfigGroup.ContextParams gartenfeldParams = (SimWrapperConfigGroup.ContextParams) simwrapperCfg.getParameterSets().get("params").stream()
				...
				.findAny().orElseThrow();
			gartenfeldParams.setShp("ADJUST TO YOUR ABSOLUTE LOCAL PATH TO: /input/gartenfeld/v6.4/shp/DNG_area.gpkg");
